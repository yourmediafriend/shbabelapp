...
class Triangle extends React.Component {
  ...
  createCircle() {
    ...
    var line = this.draw.path('M  0,50 200,46 200,54  z').fill('transparent');
    var yt;
    ...
    var circle = this.group.circle(100, 100).fill('rgba(87, 255, 241, 0.7)');
    ...
    var circleB = this.groupB.circle(100, 100).fill('rgba(244, 29, 210, 0.7)');
    ...
    var circleC = this.groupC.circle(100, 100).fill('rgba(254, 217, 4, 0.7)');
    ...
    var circleD = this.groupD.circle(100, 100).fill('rgba(255, 255, 255, 0.7)');
