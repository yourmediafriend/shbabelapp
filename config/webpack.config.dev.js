...
const bootstrapEntryPoints = require(path.join(paths.appSrc, "bootstrap/config/webpack.bootstrap.config.js"));
...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      "SvgJs": path.resolve('node_modules', 'svgjs/src/svg.js'),
    ...
    rules: [
      ...
      },
      {
        ...
        oneOf: [
          ...
          // "preprocessor" sass-loader chained to css-loader.
          {
            test: /\.scss$/,
